...
export default function CertificatePage() {
  ...
  return (
    <div className="container mx-auto py-8 space-y-8 max-w-4xl">
      ...
      <div>
        <div className="flex items-center space-x-3 text-slate-900 border-b pb-4">
          <FileText className="h-8 w-8 text-blue-500" />
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Income Certificate</h1>
            <p className="text-slate-500 mt-1">Generate a verified earnings summary for landlords, banks, or official use</p>
          </div>
        </div>
      </div>
      ...
      {lastGenerated && (
        <Alert className="bg-green-50 text-green-900 border-green-200">
          ...
          <AlertDescription>Your certificate (ID: {lastGenerated}) was generated and opened in a new tab.</AlertDescription>
        </Alert>
      )}
        ...
        <div className="md:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Select the date range for your certificate.</CardDescription>
            </CardHeader>
              ...
              <div className="flex flex-row items-center justify-between rounded-lg border p-4 shadow-sm">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-slate-500">
                    Pending shifts are clearly marked as unverified on the certificate
                  </p>
                </div>
                <Switch 
        ...
        <div className="md:col-span-1">
          <Card className="h-full flex flex-col">
            <CardHeader>
              ...
              <CardDescription>See what your certificate looks like</CardDescription>
            </CardHeader>
            <CardContent className="flex-grow flex items-center justify-center py-6">
              <FileText className="h-16 w-16 text-slate-200" />
            </CardContent>
            <CardFooter>
              <Button variant="secondary" className="w-full" onClick={handleSamplePreview}>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-blue-700">
              <p>Click 'Preview Certificate', then use the Print button on the certificate page, or press Ctrl+P (Cmd+P on Mac). Select 'Save as PDF' to create a file.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <Card className="bg-slate-50 border-slate-100">
          <CardHeader className="pb-3 text-center">
            <div className="mx-auto bg-blue-100 p-2 rounded-full w-10 h-10 flex items-center justify-center mb-2">
              <CheckCircle className="h-5 w-5 text-blue-600" />
            </div>
            <CardTitle className="text-sm font-semibold">Verified Earnings</CardTitle>
          </CardHeader>
          <CardContent className="text-center text-xs text-slate-500">
            <p>Only shifts confirmed by a FairGig verifier are included by default</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-slate-50 border-slate-100">
          <CardHeader className="pb-3 text-center">
            ...
            <CardTitle className="text-sm font-semibold">Bank & Landlord Ready</CardTitle>
          </CardHeader>
          <CardContent className="text-center text-xs text-slate-500">
