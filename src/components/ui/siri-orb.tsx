...
const SiriOrbDemo = () => {
  ...
  return (
    <div className="min-h-screen min-w-screen bg-gradient-to-br from-white to-gray-100 text-black dark:from-slate-900 dark:to-slate-700 dark:text-white flex items-center justify-center relative">
      <SiriOrb
        size={selectedSize}
        ...
        <div className="bg-white/90 dark:bg-black/40 backdrop-blur-md absolute right-4 bottom-[64px] flex w-fit flex-col justify-between gap-4 rounded-lg border border-black/10 dark:border-white/20 p-4 shadow-xl">
          ...
          <div>
            ...
            <input
              ...
              className="slider h-2 w-full cursor-pointer appearance-none rounded-lg border border-gray-300 bg-gray-200 dark:border-white/30 dark:bg-white/10"
            />
          </div>
        </div>
      )}
